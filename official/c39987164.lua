...
function s.initial_effect(c)
	...
	c:EnableReviveLimit()
	--Equip 1 Attack Position Effect monster to itself
...
function s.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() and tc:IsAttackPos() and tc:IsType(TYPE_EFFECT) and tc:IsControler(1-tp) then
		s.equipop(c,e,tp,tc)
	end
end
